 ...
 class cls_lurd_control extends cls_lurd
 {
    ...
    */
    public function display( )
    {
        ...
        $this->assign_all();
        cls_template::display( $this->display_tpl );
    }
    ...
    */
    ...
    {
        $tpl = cls_template::init();
        $tpldir = $tpl->template_dir.( empty(cls_template::$appname) ? '' : cls_template::$appname.'/' );
        if( !is_dir($tpldir) )
        {
            mkdir($tpldir, 0777);
        }
    ...
    */
    public function e_edit(&$request_array)
    {
        ...
        $this->datas[] = cls_database::get_one($sql);
