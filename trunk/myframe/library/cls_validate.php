...
class cls_validate
{
     ...
     * @param int $encoding 文字编码 默认utf-8
     * @return bool
     */
    public static function chinese_length($str, $min_len, $max_len, $encoding = "utf-8")
    {
        mb_internal_encoding($encoding);
        if(!self::chinese($str, $encoding)){
            return false;
        }
